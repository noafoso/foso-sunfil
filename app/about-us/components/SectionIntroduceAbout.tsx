...
const Sectionintroduce = () => {
    return (
        <div className='flex flex-col gap-12'>
            <div className="flex flex-col items-start gap-6 lg:px-[80px] px-4">
                <TitleHighlight
                    title='Giới thiệu chung về VietHung Auto'
                    titleClassName='text-start md:text-2xl text-3xl'
                    highlightClassName='xxl:w-[280px] xl:w-[210px] lg:w-[210px] md:w-[170px] w-[220px] lg:right-0 md:-right-1 bg-[#6AD6EEA6]/65'
                />
                <TitleDash
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-[80px] xl:gap-16 lg:gap-5 gap-8 lg:mr-[80px] custom-padding-left-right">
                        ...
                        {data.thumb.map(e => {
                            return (
                                <div key={e.id} className="flex flex-col gap-2.5 group overflow-hidden cursor-pointer">
                                    ...
                                    />
                                    <h1 className='text-[#1A1B20CC]/80 2xl:text-lg xxl:text-sm xl:text-sm text-lg text-center'>{e.name} <span className='border-b border-black'>{e.code}</span></h1>
                                </div>
                            )
                        })}
                    </div>
