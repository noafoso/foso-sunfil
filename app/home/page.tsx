...
const Home = () => {
    ...
    return (
        <div className='w-full relative lg:h-screen md:h-dvh'>
            <div className='3xl:pt-[calc(96px_+_32px)] 2xl:pt-[calc(96px_+_24px)] pt-[calc(96px_+_12px)] flex flex-col justify-between md:gap-0 gap-16 3xl:pb-8 2xl:pb-6 pb-3 h-full relative z-10'>
                <SectionIntroHome />
                {
                    isVisibleMobile &&
