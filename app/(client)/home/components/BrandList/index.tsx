    ...
    <div className="relative w-full overflow-hidden py-4 bg-[#F4F6F8]">
      <motion.div className="flex gap-6 w-max" animate={controls}>
        {[...brands, ...brands, ...brands, ...brands].map((brand, index) => (
          <div
            key={index}
            className="w-[160px] aspect-square bg-white rounded-xl border border-[#919EAB] border-opacity-20 flex flex-col items-center justify-center hover:shadow-md transition-all duration-300"
          >
